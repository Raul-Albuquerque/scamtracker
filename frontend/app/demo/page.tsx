...
export default function DemoPage() {
  const bankKey = "santander"
  const bank = BANKS[bankKey]

  return (
    <main className="container max-w-[680px] mx-auto py-6 px-6 bg-neutral-50">
      <section className="flex items-start justify-between py-3">
        <Image
        ...
        <div className="flex flex-col justify-start items-end text-end">
          ...
          <h6 className="text-[10px] sm:text-xs text-neutral-500 text-end">
            Transação: PAG20259JADJU1821828183
          </h6>
          <p className="text-xs text-neutral-500">
            Solicitação: <span>25/06/2025</span>
          </p>
        </div>
      </section>
      <section className="flex items-center justify-between pt-6">
        <div className="flex flex-col items-start justify-center">
          ...
          <h3 className="font-bold text-2xl text-neutral-500">
            R$ <span>100,00</span>
          </h3>
          <span className="text-sm text-neutral-600">15/07/2025</span>
        </div>
        <Image
          src={`/static/images/demoPage/${bank.name}/icon.png`}
          alt="Ícone sucesso"
          width={160}
          height={40}
        />
      ...
      <section className="pt-3">
        ...
        <div className="flex items-center justify-start gap-6">
          <div className="">
            <span className="block text-neutral-400 text-semibold">
              AGÊNCIA
            </span>
            <span>1234-5</span>
          </div>
      ...
      <section className="pt-14 flex flex-col md:flex-row gap-10 md:gap-2 items-start justify-between">
        <div>
          ...
          <div className="text-sm pt-2">
            <p>
              ...
              <strong className={`${bank.text}`}>3002 5060</strong>
            </p>
            <span>(capitais e regiões metropolitanas)</span>
            <p>
              <strong className={`${bank.text}`}>0800 879 0002</strong>{" "}
        ...
        <div>
          <ul className="flex items-center justify-start gap-2">
            <li
              className={`${bank.background} text-neutral-50 p-2 rounded-full`}
            >
              <Facebook />
            </li>
            <li
          ...
          <div className="text-sm pt-2">
            ...
            <p>
              <span>Ouvidoria: </span>
              <strong className={`${bank.text}`}>0800 839 7602</strong>
            </p>
          </div>
        </div>
      </section>
